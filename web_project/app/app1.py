    ...
    if request.method == 'GET':
        ...
        try:
            ...
            for text_id in text_ids:
                results.append(f"Анализ текста ID {text_id}:")
                for search_word in search_words:
                    ...
                    if existing_token:
                        results.append(f"Токен '{search_word}' уже существует для текста ID {text_id}.")
                        continue
                    ...
                    if not filtered_sentences:
                        results.append(f"Слово '{search_word}' не найдено в тексте ID {text_id}.")
                        continue
                    ...
                    session.commit()
                    results.append(f"Анализ токена '{search_word}' успешно завершен для текста ID {text_id}.")
