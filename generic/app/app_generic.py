...
from generic.database_generic.model_generic import *
...
if not os.path.isdir(template_dir):
    raise ValueError(f"Папка с шаблонами не найдена: {template_dir}")
...
# Путь к шаблонам
TEMPLATE_FOLDER = r'C:\Users\User\PycharmProjects\tolstoy-words-local\generic\app\templates'
...
DB_NAME = environ.get('DB_NAME', 'generic')
